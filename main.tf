...
module "vpc" {
  source = "git::https://github.com/shubham-rasal-123/terraform-module-vpc.git"
...
module "subnets" {
  source = "git::https://github.com/shubham-rasal-123/terraform-module-subnet.git"
...
module "ec2_instances" {
  source = "git::https://github.com/shubham-rasal-123/terraform-module-ec2.git"
...
module "s3_bucket" {
  source = "git::https://github.com/shubham-rasal-123/terraform-module-s3.git"
